...
if __name__=="__main__":
 ...
 layout=[
  [
   sgg.Violinplot(data=violindata,title="バイオリングラフの基本",xlabel=xlabel,ylabel=ylabel),
   sgg.Violinplot(data=violindata,title="幅を変更する",width=0.6)
  ],
  [
   sgg.Violinplot(data=violindata,title="向きを変える",orientation="horizontal"),
   sgg.Violinplot(data=violindata,title="曲線の滑らかさを変える",points=1000)
  ],
  [
   sgg.Violinplot(data=violindata,title="向きを変える",orientation="vertical",x=[2,3,4]),
   sgg.Violinplot(data=violindata,title="向きを変える",orientation="horizontal",y=[2,3,4])
  ],
  [
   sgg.Violinplot(data=violindata,title="極値を線で示す",showextrema=True,alpha=0.5),
   sgg.Violinplot(data=violindata,title="平均線を表示する",showmeans=True,alpha=0.5)
  ],
  [
