...
class barcode_data:
 byte_buffer=BytesIO()
 def __init__(self,value:Any,format:Literal['codabar','code128','code39','ean','ean13','ean13-guard','ean14','ean8','ean8-guard','gs1','gs1_128','gtin','isbn','isbn10','isbn13','issn','itf','jan','nw-7','pzn','upc','upca']='code39'):
 ...
 def get_type(self)->str:return self.classbarcode.name
 def support(self)->list[str]:return support_barcode