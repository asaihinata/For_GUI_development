...
class Tree(_Element):
 ...
 :rtype: list'''
 def expand(self,iid:str):'''指定した`iid`のツリーを開く。

 :param iid: 開きたい`iid`を指定する。
 :type iid: str'''
 def collapse(self,iid:str):'''指定した`iid`のツリーを閉める。
 ...
 :rtype: str'''
 def delete_node(self,iid:str):'''指定した`iid`を削除する。

 :param iid: 削除したい`iid`を指定する。
 :type iid: str'''
 def clear_width(self):'''Treeウィジェットのセルの幅を均等に戻す。'''