...
class Img_conversion:
 def __init__(self,data):self.__imgs=Image.open(data)
 @property
 def imgs(self):return self.__imgs
 def get_width(self):return self.__imgs.width
 def get_height(self):return self.__imgs.height
 def get_size(self):return self.__imgs.width,self.__imgs.height
 def get_format(self):return self.__imgs.format
 def get_mode(self):return self.__imgs.mode
 width=get_width
 height=get_height
 size=get_size
 format=get_format
 mode=get_mode
 def show(self,title=None):self.__imgs.show(title)
 def resize(self,w,h):
