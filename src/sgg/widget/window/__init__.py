...
from ...dev import bols,listchose,num0s,range_num,typelist,parsecolor
from ...graph import *
...
class WindowController:
 ...
 def _create_element(self,kw,parent,bgs=None):
  ...
  elif t=='Imagebyte':widget=Imagebyte(parent,kw)
  elif t=='Imagelink':widget=Imagelink(parent,kw)
  ...
  elif t=='QRImage':widget=QRImage(parent,kw)
  ...
  elif t=='SSBarGraph':widget=SSBarGraph(parent,kw)
  elif t=='SSBarhGraph':widget=SSBarhGraph(parent,kw)
  elif t=='Funne':widget=Funne(parent,kw)
  ...
  elif t=='RadarLine':widget=RadarLine(parent,kw)
  elif t=='RadarFill':widget=RadarFill(parent,kw)
