...
tuple[float64,float64]
 ...
 :type minor: bool'''
 @overload
 def set_zticks(self,ticks:ArrayLike,labels:Iterable[str]|None=None,minor:bool=...)->list[Tick]:'''z軸の目盛りの位置と目盛りのラベルを設定する。
 ...
 :type minor: bool'''
 @overload
 def set_zticks(self,ticks:ArrayLike,labels:Iterable[str]|None=None,minor:bool=True)->list[Tick]:'''z軸の目盛りの位置と目盛りのラベルを設定する。
 ...
 :type minor: bool'''
 @overload
 def set_zticks(self,ticks:ArrayLike,labels:Iterable[str]|None=None,minor:bool=False)->list[Tick]:'''z軸の目盛りの位置と目盛りのラベルを設定する。
