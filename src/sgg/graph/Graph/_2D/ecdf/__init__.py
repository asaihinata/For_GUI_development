...
class Ecdf(twoElement):
 def __init__(self,master,kw):
  ...
  self.plot(self.__data,complementary=self.complementary,compress=self.compress,orientation=self.orientation,linewidth=self.linewidth,line=self.line,alpha=self.alpha)
 ...
 def update(self,data=None,**kw):
  ...
  self.plot(self.__data,complementary=self.complementary,compress=self.compress,orientation=self.orientation,linewidth=self.linewidth,line=self.line)
  self._redraw()
