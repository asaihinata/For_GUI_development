...
class DScatter(threeElement):
 def __init__(self,master,kw):
  ...
  self.plot(self.__x,self.__y,self.__z,marker=self.marker,alpha=self.alpha,label=self.label)
 ...
 def update(self,x=None,y=None,z=None,**kw):
  ...
  if isinstance(z,nListlike):self.__z=NPArray(z)
 ...
 def getz(self):return self.__z.tonp()