...
def __dir__():return __all__+[k for k in globals() if k.startswith('__') and k.endswith('__')]
def counts():
 sgg.count+=1
 return sgg.count
class sgg:
 ...
 @staticmethod
 def RadarLine(**kw):return{'count':counts(),'type':'RadarLine',**kw}
 @staticmethod
 def RadarFill(**kw):return{'count':counts(),'type':'RadarFill',**kw}
 @classmethod
