...
from numpy import _CopyMode,ndarray,timedelta64,ufunc
...
**kwargs:Any
 ...
 __rsub__=__sub__
 @classmethod
 def today(cls,unit=None)->NPDate:...
 def tostr(self,unit=None,timezone='naive',casting='same_kind'):'''配列内の日付を`str`型に変換する。'''
