...
dayfirst:bool|None=False,yearfirst:bool|None=False,
ignoretz:bool=False,default:datetime|None=None)->None:
 ...
 :type default: datetime|None'''
  if default==None or not isinstance(default,datetime):default=datetime.today()
  self.__datetime=parse(
timestr,parserinfo=None,
dayfirst=dayfirst,
yearfirst=yearfirst,
ignoretz=ignoretz,
default=default)
 def __repr__(self)->str:return f'DatetimeFormat(\'{self.datetime}\')'
 @property
