...
depth_limit:int|None=None
 ...
 def __reversed__(self)->NPString:'''`numpy.fliplr`を実行する'''
 def __array__(
self,
...
**kwargs:Any
 ...
 def __mul__(self,other:int)->NPString:'''配列内の要素を`other`回付け加える
 ...
 def deep_add(self,val:int)->NPString:'''配列の深さを`val`分だけ追加する。'''
 def deep_add(self,val:int)->NPString:'''配列の深さが`val`より低い場合,深さを`val`にする。'''
 def reshape(self,size:tuple[int,...])->NPString:'''配列の形状を`size`で指定する'''
 def flatten(self)->NPString:'''配列を一次元に平坦にする'''