...
import numpy as np
from numpy._typing import (_CharLike_co, _ComplexLike_co, _FloatLike_co, _IntLike_co,
                           _UIntLike_co)
...
TypeNumber: TypeAlias = _FloatLike_co | _IntLike_co | _UIntLike_co | np.generic | _ComplexLike_co
